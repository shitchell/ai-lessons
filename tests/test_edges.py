...
class TestLessonToLessonEdges:
    ...
    def test_link_lessons_duplicate_raises(self, temp_config):
        ...
        # First link succeeds
        success1 = core.link_lessons(id1, id2, "related_to", config=temp_config)
    ...
    def test_get_related_lessons(self, temp_config):
        ...
        core.link_lessons(parent, child1, "related_to", config=temp_config)
        core.link_lessons(parent, child2, "related_to", config=temp_config)

        related = core.get_related(parent, config=temp_config)
    ...
    def test_get_related_with_depth(self, temp_config):
    ...
    def test_different_relation_types(self, temp_config):
        ...
        core.link_lessons(id1, id2, "related_to", config=temp_config)
        core.link_lessons(id1, id2, "prerequisite_of", config=temp_config)
    ...
    def test_delete_lesson_cascades_edges(self, temp_config):
        ...
        # Delete lesson
        core.delete_lesson(id1, config=temp_config)
...
class TestLessonToResourceEdges:
    ...
    def test_link_lesson_to_resource(self, temp_config):
        ...
        success = core.link_lesson_to_resource(
            lesson_id, resource_id, config=temp_config
        )
        assert success is True
    ...
    def test_unlink_lesson_from_resource(self, temp_config):
        ...
        core.link_lesson_to_resource(lesson_id, resource_id, config=temp_config)
...
class TestRuleLinkEdges:
    ...
    def test_link_to_rule_lesson(self, temp_config):
    ...
    def test_link_to_rule_resource(self, temp_config):
        ...
        success = core.link_to_rule(
            rule_id, resource_id, "resource", config=temp_config
        )
        assert success is True
    ...
    def test_unlink_from_rule(self, temp_config):
...
class TestEdgeQueries:
    ...
    def test_query_edges_by_from(self, temp_config):
        ...
        core.link_lessons(lesson_id, target1, "related_to", config=temp_config)
        core.link_lessons(lesson_id, target2, "precedes", config=temp_config)
    ...
    def test_query_edges_by_to(self, temp_config):
        ...
        core.link_lessons(source1, target_id, "related_to", config=temp_config)
        core.link_lessons(source2, target_id, "related_to", config=temp_config)
    ...
    def test_query_edges_by_relation(self, temp_config):
        """Test querying edges by relation type."""
        id1 = core.add_lesson(title="L1", content="C1", config=temp_config)
        id2 = core.add_lesson(title="L2", content="C2", config=temp_config)
        id3 = core.add_lesson(title="L3", content="C3", config=temp_config)

        core.link_lessons(id1, id2, "related_to", config=temp_config)
        core.link_lessons(id2, id3, "prerequisite_of", config=temp_config)
...
class TestEdgeConstraints:
    ...
    def test_edge_types_constrained(self, temp_config):
    ...
    def test_unique_edge_constraint(self, temp_config):
...
class TestResourceAnchors:
    ...
    def test_resource_anchor_created_with_edge(self, temp_config):
